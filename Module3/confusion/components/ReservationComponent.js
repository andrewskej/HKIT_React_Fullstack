...
class Reservation extends Component {
    ...
    async obtaionNotificationPermission() {
    ...
    async presendLocalNotification(date) {
        await this.obtaionNotificationPermission();
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    text: 'OK',
                    onPress: () => {
                        this.presendLocalNotification(this.state.date);
