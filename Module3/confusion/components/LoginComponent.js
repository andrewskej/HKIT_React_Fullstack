...
class LoginTab extends Component {
    ...
    // handleLogin= async () => {
    //     console.log(JSON.stringify(this.state));
    //     if (this.state.remember) await SecureStore.setItemAsync('userinfo', JSON.stringify({username: this.state.username, password: this.state.password}))
    //     .catch((error) => console.log('Could not save user info', error));
    //     else await SecureStore.deleteItemAsync('userinfo')
    //     .catch((error) => console.log('Could not delete user info', error));
    // }
    ...
    getImageFromCamera = async () => {
        ...
        if(cameraPermission.status === 'granted' && cameraRollPermission.status === 'granted') {
            ...
            if (!captureImage.cancelled) {
                this.processedImage( captureImage.uri );
            }
        }
    }
